...
class _GoogleAddressLookupState extends State<GoogleAddressLookup> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        color: AppTheme.fideuramWhite001,
        child: Column(
          children: [
            verticalMargin32,
            Row(
                    ...
                    children: [
                      const Padding(
                        ...
                        child: Icon(Icons.location_on_outlined,
                          size: 30, color: AppTheme.fideuramDarkGrey001,),
                      ),
                      Flexible(
  ...
  Future<Artb2bUserEntityAddress?> getDetails(String placeId) async {
    ...
    if (result != null && result.result != null && mounted) {
      ...
      return Artb2bUserEntityAddress(address: _address, place: _place,
